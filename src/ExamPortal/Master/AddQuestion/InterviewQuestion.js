...
const InterviewQuestion = () => {
  ...
  const AddQuestonData = () => {
    var quest = {
      content_id: conten.current.value,
      question: question.current.value,
      option_1: optionone.current.value,
      option_2: optiontwo.current.value,
      option_3: optionthree.current.value,
      option_4: optionfour.current.value,
      currect_option: currectop.current.value,
    };
    axios({
